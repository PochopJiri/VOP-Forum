<?php
// source: H:\Programy\xampp\htdocs\forum\app/config/config.neon 
// source: H:\Programy\xampp\htdocs\forum\app/config/config.local.neon 

class Container_0bec2dd18f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\Security\IAuthenticator' => [1 => ['27_App_Model_Authenticator']],
			'App\Model\Authenticator' => [1 => ['27_App_Model_Authenticator']],
			...
			'App\Presenters\PostsPresenter' => [1 => ['application.4']],
			'App\Presenters\ProfilePresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'27_App_Model_Authenticator' => 'App\Model\Authenticator',
			...
			'application.4' => 'App\Presenters\PostsPresenter',
			'application.5' => 'App\Presenters\ProfilePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'H:\Programy\xampp\htdocs\forum\app',
			'wwwDir' => 'H:\Programy\xampp\htdocs\forum\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'H:\Programy\xampp\htdocs\forum\app/../temp',
		];
	}
	...
	public function createService__26_App_Forms_SignUpFormFactory(): App\Forms\SignUpFormFactory
	{
		$service = new App\Forms\SignUpFormFactory($this->getService('24_App_Forms_FormFactory'),
			$this->getService('27_App_Model_Authenticator'));
		return $service;
	}


	public function createService__27_App_Model_Authenticator(): App\Model\Authenticator
	{
	...
	public function createServiceApplication__4(): App\Presenters\PostsPresenter
	{
		$service = new App\Presenters\PostsPresenter($this->getService('database.default.context'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	public function createServiceApplication__5(): App\Presenters\ProfilePresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'H:\Programy\xampp\htdocs\forum\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('H:\Programy\xampp\htdocs\forum\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('H:\Programy\xampp\htdocs\forum\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=forumg6', 'root',
			'rootroot', ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_0bec2dd18f $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('H:\Programy\xampp\htdocs\forum\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('27_App_Model_Authenticator'));
